        ...
        >
          <v-card-title>
            <v-btn
              color="primary"
              large
              :to="`/receptores/editar/${this.getReceptorID()}/contatos/adicionar`"
            >
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      let result = await receptorContatosController.list(
        filters,
        pagination.page,
    ...
    async onDeleteItem(item) {
      this.SHOW_LOADER()
      let receptorContatosController = new ReceptorContatosController();
      let result = await receptorContatosController.delete(item,this.getReceptorID());
      this.CLOSE_LOADER()
    ...
    onEditItem(item) {
      this.$router.push({ path: `/receptores/editar/${this.getReceptorID()}/contatos/editar/${item}`});
    },
